...
Shared project guidance for Codex, Claude Code, and other coding agents.
Claude Code imports this file through `CLAUDE.md`.
For work under `api/`, also read `api/AGENTS.md` before starting.
...
## Process
These working practices apply regardless of the coding agent:
